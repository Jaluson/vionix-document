...
```mermaid
flowchart TB
  frontend["Vue Frontend"] --> api["Spring Boot 4 API"]
...
| 完整开发环境 | 当前组件 + MySQL、Redis、Backend、Frontend | Backend 骨架和迁移入口已开始交付，Frontend 与完整编排待补齐 |
